...
var meteorData_1 = require("./meteorData");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var mongoDBDatabases, meteorGalaxyData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, mongoData_1.fetchMongoDBDatabases)()];
                case 1:
                    mongoDBDatabases = _a.sent();
                    return [4 /*yield*/, (0, meteorData_1.fetchMeteorGalaxyServers)()];
                case 2:
                    meteorGalaxyData = _a.sent();
